...
Judge whether the fix satisfies the acceptance criteria, whether behavior stayed intact, and whether the patch introduced regressions or new slop. Return `PASS`, `FAIL`, `NEEDS_HUMAN`, or `FALSE_POSITIVE` with evidence and required follow-up.
